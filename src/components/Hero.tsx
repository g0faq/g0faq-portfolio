...
export function Hero() {
  return (
    <section id="top" className="hero-section relative overflow-hidden pb-16 pt-28 sm:pt-32 lg:pb-20">
        ...
        <Reveal>
          <div className="max-w-3xl">
            ...
            <p className="mt-6 max-w-2xl text-lg leading-8 text-white/72 sm:text-xl">
              Собираю сайты, простые CRM, Telegram-ботов и автоматизацию под реальные задачи: заявки, записи, учёт, уведомления и быстрый запуск без лишней бюрократии.
            </p>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              {heroBadges.map((badge) => (
                <span key={badge} className="tag tag-hero"><i className="h-1.5 w-1.5 rounded-full bg-mint shadow-[0_0_12px_rgba(121,242,192,.8)]" />{badge}
                </span>
              ))}
            </div>
          </div>
